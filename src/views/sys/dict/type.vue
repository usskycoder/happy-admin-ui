<template>
	<el-card>
		...
		<!-- 动态数据 -->
		<el-drawer v-if="dataSqlVisible" v-model="dataSqlVisible" :title="dataSqlTitle" size="80%" :close-on-press-escape="true">
			<data-sql :dict-type-id="dictTypeId"></data-sql>
		</el-drawer>

		<!-- 字典配置 -->
		<el-drawer v-if="dictDataVisible" v-model="dictDataVisible" :title="dictDataTitle" size="80%" :close-on-press-escape="true">
